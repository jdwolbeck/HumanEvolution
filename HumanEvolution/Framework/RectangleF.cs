...
{
    //Credit https://github.com/dmanning23/RectangleF/blob/master/RectangleF/RectangleF.SharedProject/RectangleF.cs
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        public static void Intersect(ref RectangleF value1, ref Rectangle value2, out RectangleF result)
        {
            if (value1.Intersects(value2))
            {
                float right_side = Math.Min(value1.X + value1.Width, value2.X + value2.Width);
